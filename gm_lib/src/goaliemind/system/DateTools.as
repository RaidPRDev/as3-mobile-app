package goaliemind.system 
{
	...
	public class DateTools 
	{
		...
		static public var Days:Array = [ "Sunday", "Monday", "Tuesday", "Wednessday", "Thursday", "Friday", "Saturday" ];
		...
		*/
		...
		/**
		 * 	Convert an ActionScript Date.time (milliseconds) to date Format: (mm/dd/year)
		 */
		public static function convertASDateTimeToDateFormatStyle( time:String ):String 
		{
			var newDate:Date = new Date();
			
			newDate.setTime(time);
			
			var newDateFormat:String = (newDate.getMonth() + 1) + "/" + newDate.getDate() + "/" + newDate.getFullYear();
