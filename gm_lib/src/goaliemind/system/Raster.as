...
package goaliemind.system
{
	...
	public class Raster extends BitmapData
	{
		...
		*/
		...
		public function filledCircle(x:int, y:int, r:Number, colour:uint = 0x000000):void
		{
			var myCircle:Shape = new Shape();
			myCircle.graphics.beginFill(colour, 1.0);
			myCircle.graphics.drawCircle(x, y, r);
			...
			this.draw(myCircle, matrix);
		}
		
		public function filledBox(rect:Rectangle, colour:uint):void
		{
			var myCircle:Shape = new Shape();
			myCircle.graphics.beginFill(colour, 1.0);
			myCircle.graphics.drawRect(rect.x, rect.y, rect.width, rect.height);
			myCircle.graphics.endFill();
			...
			var myCircleBitmapData:BitmapData = new BitmapData(myCircle.width, myCircle.height, false);
			this.draw(myCircle, matrix);
		}		
