package goaliemind.view.createuser.screens.terms 
{
	 ...
	 * (c) 2015
	 */
	public class TermsOfUseScreen extends CreateUserPanelScreen
	{
		...
		public function TermsOfUseScreen() 
		{
			super();
		}
		...
		private function onTransitionInComplete(e:Event):void 
		{
			...
			this._infoLoader = new InfoLoader(GlobalSettings.TERMSOFUSE + ".dat");
