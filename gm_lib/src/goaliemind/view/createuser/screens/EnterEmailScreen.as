package goaliemind.view.createuser.screens 
{
	 ...
	 * (c) 2015
	 */
	public class EnterEmailScreen extends CreateUserPanelScreen
	{
		...
		public function EnterEmailScreen() 
		{
			super();
		}
		...
		private function createSubHeader():void
		{
			...
			_subPanelContent.defaultIcon = this.loadImageFactory(_manager.appCore.theme.createUserTheme.largeEmailIconTexture);
		...
		private function createInput():void
		{
			...
			this._input.prompt = "Enter your email";
