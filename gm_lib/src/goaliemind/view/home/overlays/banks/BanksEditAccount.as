package goaliemind.view.home.overlays.banks 
{
	 ...
	 * (c) 2015
	 */
	public class BanksEditAccount extends HomePanelScreen
	{
		private var _list:List;
		
		public function BanksEditAccount() 
		{
			super();
		}
		...
		{
			LogUtil.log("BanksEditAccount.onBackButton()");
		...
		{
			LogUtil.log("BanksEditAccount.onListChange() " + _list.selectedIndex);
