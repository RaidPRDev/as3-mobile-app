package goaliemind.view.home.overlays.banks.accounts 
{
	 ...
	 * (c) 2015
	 */
	public class AddPayPalAccount extends HomePanelScreen
	{
		...
		{
			LogUtil.log("AddPayPalAccount.onBackButton()");
		...
		{
			LogUtil.log("AddPayPalAccount.onActionButton()");
		...
		private function createList():void
		{
			...
			var items:Array = [];
			items[items.length] = { label:"PayPal Email Address", isEnabled:true, icon:null, eventName:"" };
			items.fixed = true;
