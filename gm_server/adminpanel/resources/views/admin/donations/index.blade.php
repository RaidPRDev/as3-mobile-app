            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">Donations</span>
                    </div>
                    <div class="actions">
                    	
                        <div >
                        	<a class="label-info btn-outline btn-circle btn-sm" href="{{ route('admin.donations.create') }}" style="color:#fff;text-decoration: none;">
...
<script>
	$(document).ready(function(){
		$('#list-records').dataTable({
			"ajax": "<?php echo url('admin/ajax_get_donations');?>",
	        "columns": [
	            { "data": "sr_no" },
	            { "data": "name" },
	            { "data": "api" },
