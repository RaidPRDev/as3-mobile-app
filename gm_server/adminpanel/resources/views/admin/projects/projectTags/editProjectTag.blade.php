			...
			<div class="tabbable-line boxless tabbable-reversed">
				<div class="portlet box blue-hoki">
					...
					<div class="portlet-body form" style="display: block;">
						@include('error')
						<!-- BEGIN FORM-->
						<form action="{{ route('admin.projects.updateProjectTags', $project_tag->id) }}" method="POST" class="form-horizontal" id="update_projecttag" novalidate="novalidate" enctype="multipart/form-data">
							{{csrf_field()}}
							...
							<div class="form-body">
								<div class="form-group @if($errors->has('name')) has-error @endif">
									...
									<div class="col-md-4">
										<input type="text" id="name" name="name" class="form-control validate[required]" value="{{ old('name', $project_tag->name) }}" />
										@if($errors->has("name"))
