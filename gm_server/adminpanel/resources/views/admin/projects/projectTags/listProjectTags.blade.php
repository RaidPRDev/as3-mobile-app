            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">Project Tags</span>
                    </div>
                    <div class="actions">
                    	<div>
                        	<a class="label-info btn-outline btn-circle btn-sm" href="{{ route('admin.projects.createProjectTags') }}" style="color:#fff;text-decoration: none;">
