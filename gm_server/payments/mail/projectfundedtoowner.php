			 ...
			 -moz-border-radius: 3px ; text-align:center; ">
				...
				<div style=" clear: both ; ">
					...
					<span style="background-color: #CACFD3 ; border-radius: 50% ;
					 ...
					 text-align: center ; width: 40px ; margin:0 auto;"><?php echo ($emailInfo['projectUserInitials']) ?></span>
					
					<div style="color: #323a45 ; font-size: 17px ; font-weight: bold ;
					 text-align: center ; font-family: 'Open Sans',
					 sans-serif;text-transform:uppercase;padding-top:10px;">Hello <?php echo ($emailInfo['projectUsername']) ?>!</div>
					
					<p style="margin-top: 10px ; color: #747c83 ; font-size: 13px ;
					 font-weight: 600 ; line-height: 18px ; text-align: center ; text-transform:
					 uppercase; font-family: 'Open Sans', sans-serif;">You have received funds from <b><?php echo ($emailInfo['uname']) ?></b>!</p>
					 
					<p style="margin-top: 10px ; color: #747c83 ; font-size: 20px ;
					 font-weight: 600 ; line-height: 18px ; text-align: center ; text-transform:
					 uppercase; font-family: 'Open Sans', sans-serif;">For the amount of $<?php echo ($emailInfo['fundAmount']) ?> USD!</p>
